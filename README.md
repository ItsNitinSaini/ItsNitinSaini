...
- 🔹 **Gym Wars** — a competitive fitness tracking web app for friend groups. Built with React, Vite & Supabase. Features leaderboards, streaks, weekly challenges, a Hall of Fame, and an admin panel.
- 🔹 **AI vs Human Text Classifier** — a machine learning model that detects whether a piece of text was written by a human or generated by AI, trained using Transformers.

🌱 **I'm currently learning**

- 🔹 Advanced React patterns and scalable frontend architecture
- 🔹 Backend system design and REST API best practices
- 🔹 ML pipelines and model training with PyTorch & Transformers

💬 **Ask me about**

- 🔹 React, Node.js, Express, Supabase, Python
- 🔹 Building full-stack apps from scratch as a student
- 🔹 Machine Learning — model training, Transformers, classification

📬 **Open to internships** in software development, full-stack, or ML roles

⚡ **Fun fact** — I built a leaderboard app just to beat my friends at the gym. My code works. I'm just not always sure why.
