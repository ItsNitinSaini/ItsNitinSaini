...
- 🔹 **Gym Wars** — a competitive fitness tracking web app for friend groups. Built with React, Vite & Supabase. Features leaderboards, streaks, weekly challenges, a Hall of Fame, and an admin panel.(Original Idea Is Completed And Deployed)
...
- 🔹 ML pipelines and model training with PyTorch & Transformers (On Hold)
